...
class Utils(
    ...
    init {
        ...
        // Set top padding based on user preference (0-300)
        topPadding = prefs.get(P.TOP_PADDING, P.TOP_PADDING_DEFAULT)

        // Set drawable size based on user preference
        val iconSizePreference = prefs.get(P.NOTIFICATION_ICON_SIZE, P.NOTIFICATION_ICON_SIZE_DEFAULT)
        val iconSizeDp = when (iconSizePreference) {
            "enlarged" -> {
                DRAWABLE_SIZE_ENLARGED
            }
            "small" -> {
                DRAWABLE_SIZE_SMALL
            }
        ...
        drawableSize = dpToPx(iconSizeDp).toInt()
    }
    ...
    companion object {
        ...
        const val DRAWABLE_SIZE_SMALL: Float = 24f
        const val DRAWABLE_SIZE: Float = 32f
        const val DRAWABLE_SIZE_ENLARGED: Float = 40f
